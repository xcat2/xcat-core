...
'adddhcpstatements' => 'Custom dhcp statements for administrator use (not implemneted yet)',
    ...
    hosts => {
        ...
        descriptions => {
            ...
            otherinterfaces => 'Other IP addresses to add for this node.  Format: -<ext>:<ip>,<intfhostname>:<ip>,.... If we want to add node.domain for ip, format can be: -<ext>:<ip>:1,<intfhostname>:<ip>,...',
            comments => 'Any user-written notes.',
            disable  => "Set to 'yes' or '1' to comment out this row.",
        },
    },
