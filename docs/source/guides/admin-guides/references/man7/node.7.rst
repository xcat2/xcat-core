...
\ **dockerflag**\  (vm.othersettings)
 ...
 This is a semicolon-delimited list of key-value pairs to be included in a vmx file of VMware or KVM. DO NOT use 'chdef <node> -p vmothersetting=...' to add new options to it because chdef uses commas, not semicolons, to separate items.
