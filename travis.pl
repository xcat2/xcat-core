...
sub install_xcat{
    ...
    my @cmds = ("cd ./../../xcat-core && sudo ./mklocalrepo.sh",
               ...
               "sudo echo \"deb [arch=amd64] http://xcat.org/files/xcat/repos/apt/2.14/xcat-dep trusty main\" >> /etc/apt/sources.list",
               "sudo echo \"deb [arch=ppc64el] http://xcat.org/files/xcat/repos/apt/2.14/xcat-dep trusty main\" >> /etc/apt/sources.list",
