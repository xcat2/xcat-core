...
when "fedora", "redhat", "centos" # :pragma-foodcritic: ~FC024 - won't fix this
  ...
  if platform == "redhat" ||  platform == "centos"
     default["openstack"]["network"]["platform"]["quantum_openvswitch_agent_packages"] = ["openstack-quantum-openvswitch"]
     default["openstack"]["network"]["platform"]["quantum_openvswitch_agent_service"] = "quantum-openvswitch-agent"
  end
when "suse"
  default["openstack"]["network"]["platform"] = {
