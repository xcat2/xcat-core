...
It's used to disconnection CEC, Frame and IBM Flex Compute Nodes (Compute Node for short) from hardware server.
...
To disconnect all Compute Nodes from there related hardware service:
