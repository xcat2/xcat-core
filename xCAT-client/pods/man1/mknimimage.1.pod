...
The source of software to use when creating the new NIM lpp_source resource. This could be a source directory, (ex. /dev/cd0), or a previously defined NIM lpp_source resource name.  B<When specifying a source directory make sure to use the full path name.>
