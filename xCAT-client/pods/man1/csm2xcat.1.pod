...
The csm2xcat command must be run on the Management Node of the CSM system that you want to migrate to xCAT.  The commmand will build  three xCAT stanza files that can update the xCAT database with the chdef command. 
