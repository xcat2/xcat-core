"""Decoding what dig, curl and tftp printed, and the process runner.
...
from blackboxtest_lib import dnsc, httpc, proc, tftpc
...
class HttpDecodingTests(unittest.TestCase):
    ...
    def setUp(self):
        self.dir = tempfile.mkdtemp(prefix="blackboxtest-http-")
...
class TftpDecodingTests(unittest.TestCase):
    ...
    def setUp(self):
        self.dir = tempfile.mkdtemp(prefix="blackboxtest-tftp-")
        self.addCleanup(shutil.rmtree, self.dir, True)
...
class ProcessTests(unittest.TestCase):
    ...
    def test_a_missing_program_is_an_unsupported_host_not_a_failure(self):
        from blackboxtest_lib.errors import UnsupportedError
