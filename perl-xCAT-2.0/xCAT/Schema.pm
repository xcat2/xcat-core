...
servicenode => {
 ...
 descriptions => {
  ...
  nameserver => 'Do we set up DNS on this service node? Valid values:yes or 1, no or 0. If blank, means yes.',
  dhcpserver => 'Do we set up DHCP on this service node? Valid values:yes or 1, no or 0. If blank, means yes.  We may also support: <ifname>,<noderange>,<dynamicrange>, but this has not been decided yet.',
  tftpserver => 'Do we set up TFTP on this service node? Valid values:yes or 1, no or 0. If blank, means yes.',
  nfsserver => 'Do we set up file services (HTTP,FTP,or NFS) on this service node? Valid values:yes or 1, no or 0. If blank, means yes.',
  conserver => 'Do we set up Conserver on this service node? Valid values:yes or 1, no or 0. If blank, means yes.',
  monserver => 'Is this a monitoring event collection point? Valid values:yes or 1, no or 0. If blank, means yes.',
  ldapserver => 'Do we set up ldap caching proxy on this service node? Valid values:yes or 1, no or 0. If blank, means yes.',
  ntpserver => 'Do we set up and ntp server on this service node? Valid values:yes or 1, no or 0. If blank, means yes.',
     comments => 'Any user-written notes.',
     disable => "Set to 'yes' or '1' to comment out this row.",
 },
  },
